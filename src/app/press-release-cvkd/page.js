...
const PRESSRELEASECVKD = () => {
    ...
    const meta = {
        title : "Cadrenal Therapeutics Press Release - Stockverse",
        description : "Read the latest press release on Cadrenal Therapeutics (CVKD) from Stockverse. Learn about their groundbreaking research and advancements in cardiovascular health.",
        og_title : "Cadrenal Therapeutics Press Release - Stockverse",
        og_description : "Discover Cadrenal Therapeutics' latest news and updates on cardiovascular innovations. Read more on Stockverse.",
