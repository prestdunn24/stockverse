...
const PRESSRELEASENEOV = () => {
    ...
    const pressReleaseUrl = `https://stockverse.com/pr2025`; // The current URL
    ...
    return (
        <div className="w-full h-full mx-auto xl:container lg:px-[15%] max-xl:px-3">
            ...
            <div className="py-12 gap-y-6 flex max-lg:flex-col-reverse max-lg:items-start items-center justify-between">
                <h1 className="text-3xl font-serif font-medium max-sm:text-xl  text-left text-primaryText/70 lg:w-[70%] leading-[130%]">Cadrenal biotechechnology index bell ringing at Nasdaq</h1>
            ...
            <div className="flex flex-col gap-8 py-4">
                <p className="text-base text-primaryText leading-[200%]">Ponte Vedra Beach-based biopharmaceutical company Cadrenal Therapeutics Inc. was among several companies that rung in the bell Monday to open the Nasdaq.</p>
                <p className="text-base text-primaryText leading-[200%]">The biotech companies rung in the bell as part of the annual J.P. Morgan Healthcare Conference, the first national industry gathering since the killing of UnitedHealthcare CEO Brian Thompson in New York ahead of investor day meetings.</p>
                <p className="text-base text-primaryText leading-[200%]">The event typically highlights new drugs, deals and investors, but in the wake of the shooting, <Link href="https://www.bizjournals.com/sanfrancisco/news/2025/01/13/jpm-security-luigi-mangione-brian-thompson-united.html" className="text-primaryHeading">security is a key issue for this year's event.</Link></p>
                <p className="text-base text-primaryText leading-[200%]">"It’s an honor to represent Jacksonville and Florida as part of the Nasdaq Biotech Index companies to ring the opening bell from San Francisco," Cadrenal CEO & Founder Quang X. Pham told the Business Journal Monday. "This morning is the kickoff of the annual JP Morgan Healthcare Conference Week, our biggest and most important gathering.</p>
                <p className="text-base text-primaryText leading-[200%]">Despite the added security and national discourse, Pham said he plans to highlight the region's success and use the event to promote the local tech and health care scene.</p>
