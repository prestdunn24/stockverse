...
export default function Disclaimer(){
    return(
                ...
                <h1 className="text-3xl font-sansSemibold text-primaryText mt-16">Privacy Policy</h1>
                <p className="text-lg font-sansMedium text-primaryText">
                  Effective Date: [August, 2024]
                </p>
                ...
                <p className="text-base text-primaryText">Email: <span className="font-sansSemibold">mark@stockverse.ai</span></p>
              </div>
            </div>
    );
}